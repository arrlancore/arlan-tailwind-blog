...
tags: ['git', 'github']
draft: false
images: ['/static/images/tutorial-panduan-belajar-git.jpg']
layout: PostBanner
summary: Belajar Konsep Dasar & Cara Menggunakan Git Untuk Mengontrol Versi Codingan-mu Dengan Fitur-Fitur seperti branching, staging, dll.
---

Sebagai seorang software developer, saya tidak bisa terlepas dari tool yang satu ini yaitu `git`. Karna dengan `git` biasanya saya bisa melacak perubahan dan memaintain versi kodingan di project yang sedang saya kerjakan dengan mudah.
