...
Sebagai seorang software developer, saya tidak bisa terlepas dari tool yang satu ini yaitu `git`. Karna dengan `git` biasanya saya bisa melacak perubahan dan memaintain versi kodingan di project kita dengan mudah.
